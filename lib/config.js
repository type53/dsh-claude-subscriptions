...
export const Config = z.object({
   ...
   * `console` = drive the official `claude` CLI; keeps the first-party
   * entitlement, so opus/sonnet work.
   */
  mode: z.union(['token', 'console']).default('token'),
  /**
...
export function resolveAdapterOptions(config) {
  ...
  return {
    ...
    mode: config.mode === 'console' ? 'console' : 'token',
    consoleSystemPrompt:
